...
/**
 * The measurement harness, installed into the consumer's test source set.
 *
 * This is deliberately a file the developer owns rather than hidden generated
 * code: measuring a real app always needs local adjustment (a stub Application,
 * DI bootstrapping, extra composition locals), and every default below was
 * corrected against a shipping app rather than guessed.
 */
object Harness {
